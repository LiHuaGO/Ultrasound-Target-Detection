...
try:
    from .modules.ufea import UFEA
except ImportError:
    from ultralytics.nn.modules.ufea import UFEA
...
class RTDETRDetectionModel(DetectionModel):
    ...
    Attributes:
        cfg (str): The configuration file path or preset string. Default is 'rtdetr-n.yaml'.
    ...
    def __init__(self, cfg="rtdetr-n.yaml", ch=3, nc=None, verbose=True):
        """
